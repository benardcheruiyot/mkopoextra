...
const LoanProcessing = () => {
  ...
  useEffect(() => {
    document.title = 'Loan Processing | LendHub';
  }, []);
  ...
  const getLoanTimeline = (loanStatus) => {
      ...
      return [
        {
          ...
          description: 'Your fee payment has been confirmed successfully.',
          status: 'done',
        },
        {
          id: 2,
        ...
        },
        {
          ...
          description: 'Funds are ready or will be sent shortly after approval.',
          status: 'done',
        },
        {
          id: 4,
    ...
    return [
      ...
      },
      {
        id: 3,
        title: 'Disbursement',
        description: 'Once approved, funds will be sent within 48 hours.',
        status: 'pending',
      },
      {
        id: 4,
