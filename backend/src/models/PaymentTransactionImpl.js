...
class PaymentTransactionImpl {
  constructor(data) {
    ...
    this.providerReceiptNumber = this.receiptNumber;
  ...
  static async create(data) {
    PaymentTransactionImpl.purgeStaleTransactions();

    const transaction = new PaymentTransactionImpl({
      ...data,
      id: `PAYMENT-${Date.now()}`,
    });
  ...
  static async findByCheckoutRequestId(checkoutRequestId) {
    ...
    return transaction ? PaymentTransactionImpl.expireIfPending(transaction) : null;
  }
  ...
  static async findLastByUserId(userId) {
    ...
    return lastTransaction ? PaymentTransactionImpl.expireIfPending(lastTransaction) : null;
  }
...
module.exports = PaymentTransactionImpl;
